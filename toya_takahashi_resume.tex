...
\begin{rSection}{Education}
    ...
    Relevant Coursework: Robotic Manipulation, Autonomous Navigation, Accelerated Computing, Deep Learning, Numerical Algorithms, Controls
\end{rSection}
...
\begin{rSection}{Experience}
    ...
    \item Enhanced an end-to-end robot manipulator object-following workflow by tripling throughput and improving stability of object pose estimations from a deep neural network.
