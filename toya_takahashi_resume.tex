...
\address{(907)~$\cdot$~538~$\cdot$~1519 \\ \href{mailto:toyat@mit.edu}{\underline{toyat@mit.edu}} \\ \href{https://www.linkedin.com/in/toya-takahashi/}{\underline{linkedin/toya-takahashi}} \\ \href{https://github.com/toyat522}{\underline{github/toyat522}} \\ San Jose, CA}

\begin{document}

\begin{rSection}{Education}

	\textbf{Massachusetts Institute of Technology (M.I.T.)} \hfill May 2026 \\ 
...
\begin{rSubsection}{MIT Sensing, Perception, Autonomy, and Robot Kinetics (SPARK) Lab}{September 2024 - Present}{Undergraduate Researcher}{Cambridge, MA}
    \item Implemented tools using the Robot Operating System (ROS 2) that expose robot state to LLM agents, enabling grounded reasoning and context-aware responses for LLM-driven autonomous robot navigation.
...
%    \item Guided students through labs on computer vision, state estimation, motion planning, and control using the MIT racecar robotic platforms.
...
\begin{rSubsection}{NVIDIA Isaac ROS}{May 2025 - August 2025}{Systems Software Robotics Solutions Intern}{Santa Clara, CA}
    \item Developed a CUDA-accelerated suite of ROS 2 nodes for running a TensorRT-optimized Grounding DINO open-set object detection model, including a text tokenizer, text and image tensor encoders, and an output tensor decoder with visualization.
...
\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
    Computer Languages & Python, C/C++, Go, NumPy, CUDA, SystemVerilog, RISC-V Assembly \\
    Tools & Git, Docker, Linux, Robot Operating System 2 (ROS 2), Nix, PyTorch, Drake
\end{tabular}
