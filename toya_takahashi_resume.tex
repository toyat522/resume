...
\begin{rSection}{Education}
    ...
    Relevant Coursework: Robotic Manipulation, Autonomous Navigation, Software Performance Engineering, Distributed Systems, Deep Learning
\end{rSection}
...
\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
    Computer Languages & Python, C/C++, Go, NumPy, CUDA, MATLAB, SystemVerilog, RISC-V Assembly \\
    Tools & Git, Docker, Linux, Robot Operating System 2 (ROS 2), PyTorch, Drake, Computer-Aided Design (CAD)
\end{tabular}
